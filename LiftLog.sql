-- Progettazione Web 
DROP DATABASE if exists LiftLog; 
CREATE DATABASE LiftLog; 
USE LiftLog; 
-- MySQL dump 10.13  Distrib 5.6.20, for Win32 (x86)
--
-- Host: localhost    Database: LiftLog
-- ------------------------------------------------------
...
CREATE TABLE `orario` (
  ...
  KEY `FK_orario_turno` (`turno`),
  CONSTRAINT `FK_orario_turno` FOREIGN KEY (`turno`) REFERENCES `turno` (`id`),
  CONSTRAINT `FK_orario_utente` FOREIGN KEY (`dipendente`) REFERENCES `utente` (`username`)
...
INSERT INTO `scheda` VALUES (4,7,'2023-06-03'),(5,7,'2023-06-03');
...
INSERT INTO `svolgimento` VALUES (14,1,4,3,10,30),(15,4,4,3,10,30),(16,6,4,3,10,30),(17,13,4,3,10,30),(18,10,4,3,10,30),(19,1,5,3,10,30);
...
-- Dump completed on 2023-06-03 12:21:47
